...
public class Employee {
	...
	public void setDeptId(int deptId) { // 부서명은 부서번호에 따라 지정되는 것이라 setDeptId에 setDeptName을 넣어준다.
		this.deptId = deptId;
		if (this.deptId == 10) {
			this.deptName = "인사";
		} else if (this.deptId == 20) {
...
//	}
	...
	public String toString() {
		return "Employee [employeeId=" + employeeId + ", name=" + name + ", deptId=" + deptId + ", deptName=" + deptName
